...
public class MeanQueueLambda {	
	...
	public static void run(double T, double N, double λ0, double μ0) {
		...
		for (double μ = μ0; μ < 0.8; μ += 0.1) {
			...
			String string = "Tempo medio in coda e rate di arrivo con rate di servizio=" + Utility.round(μ, 2);
